// DO NOT EDIT THIS FILE! IT IS AUTOMATICALLY GENERATED FROM FILE "src/Tp4Lexer202420.gold"
import gold.*;
...
public final class Tp4Lexer202420 {
  ...
  static {
    ...
    $try:try {
      ...
      $rethrow($throwable,Tp4Lexer202420.class,null,$line);
    }
  }
  ...
  public static Object chars(Object string) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Tp4Lexer202420.class,"chars",$line);
    }
    return $result;
  }
  public static Object charsStrings(Object strings) {
    ...
    $try:try {
      ...
      $v6:for (Object s:GCollections.unmodifiableCollection(strings)) {
        $v5.union(GCollections.unmodifiableSet(((java.lang.Iterable)(Tp4Lexer202420.chars(s)))));
      }
      $result=$v5;
      if (true) break $try;
      $line=33;
      ...
      $rethrow($throwable,Tp4Lexer202420.class,"charsStrings",$line);
    }
    return $result;
  }
  public static Object elements(Object array) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Tp4Lexer202420.class,"elements",$line);
    }
    return $result;
  }
  public static Object prefixes(Object string) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Tp4Lexer202420.class,"prefixes",$line);
    }
    return $result;
  }
  public static Object splits(Object string) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Tp4Lexer202420.class,"splits",$line);
    }
    return $result;
  }
  public static Object allPrefixes(Object strings) {
    ...
    $try:try {
      ...
      $v20:for (Object s:GCollections.unmodifiableCollection(strings)) {
        $v19.union(GCollections.unmodifiableSet(((java.lang.Iterable)(Tp4Lexer202420.prefixes(s)))));
      }
      $result=$v19;
      if (true) break $try;
      $line=40;
      ...
      $rethrow($throwable,Tp4Lexer202420.class,"allPrefixes",$line);
    }
    return $result;
  }
  public static Object translationGet(Object q) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Tp4Lexer202420.class,"translationGet",$line);
    }
    return $result;
  }
  public static Object runLexer(Object M, Object input) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Tp4Lexer202420.class,"runLexer",$line);
    }
    return $result;
  }
    ...
    $try:try {
      ...
      if ($opMembrY(q,allSymbols)) {
        ...
        if ($opLessqY($opAbsolY(q),1)) {
          ...
          $line=56;
          for (Object $v21:GCollections.unmodifiableCollection(Tp4Lexer202420.splits(q))) {
            java.util.Iterator $v22=GCollections.unmodifiableCollection($v21).iterator();
            Object s=$v22.next();
            Object t=$v22.next();
            $line=57;
            if ((!$bool(Tp4Lexer202420.problems($cast(java.lang.String.class,s)))&&!$bool(Tp4Lexer202420.problems($cast(java.lang.String.class,t))))) {
              $line=57;
              $result=false;
              if (true) break $try;
            }
      ...
      $rethrow($throwable,Tp4Lexer202420.class,"problems",$line);
    }
    return $result;
  }
    ...
    $try:try {
      ...
      if ($opEqualY(n,0)) {
        ...
        if ($opMembrY(q,allSymbols)) {
          ...
          $line=73;
          $result=Tp4Lexer202420.translationGet(q);
          if (true) break $try;
        }
        else {
          $line=74;
          if ($opEqualY(n,1)) {
            ...
            $line=76;
            for (Object $v23:GCollections.unmodifiableCollection(Tp4Lexer202420.splits(q))) {
              java.util.Iterator $v24=GCollections.unmodifiableCollection($v23).iterator();
              Object s=$v24.next();
              Object t=$v24.next();
              $line=77;
              x=$fix(Tp4Lexer202420.translationPreOps(s));
              $line=78;
              y=$fix(Tp4Lexer202420.translationPreOps(t));
              $line=79;
      ...
      $rethrow($throwable,Tp4Lexer202420.class,"translationPreOps",$line);
    }
    return $result;
  }
  public static ITransducer createLexer() {
    ...
    $try:try {
      $line=91;
      Tp4Lexer202420.initialize();
      $line=93;
      preOps=$cast(ISet.class,$fix(Tp4Lexer202420.allPrefixes(allSymbols)));
      $line=94;
      preKW=$cast(ISet.class,$fix(Tp4Lexer202420.allPrefixes(keyWords)));
      $line=95;
      ...
      $line=107;
      Object \u03A3=$fix($opUnionY($opUnionY($opUnionY(alphaNum,Tp4Lexer202420.charsStrings(allSymbols)),skipChars),GCollections.asSet(':','\"')));
      $line=110;
      Object q_0=$fix("INIT");
      $line=111;
      Object F=$fix(GCollections.asSet("INIT"));
      $line=112;
      $result=$invokeConstructor(GDeterministicTransducer.class,new Object[]{Q,\u03A3,Out,q_0,F,new GMethod(Tp4Lexer202420.class,"\u03B4"),new GMethod(Tp4Lexer202420.class,"g"),new GMethod(Tp4Lexer202420.class,"h")});
      if (true) break $try;
      $line=113;
      $rethrow(new RuntimeException("The function \"createLexer()\" did not return a value."));
    }
    catch (Throwable $throwable) {
      $rethrow($throwable,Tp4Lexer202420.class,"createLexer",$line);
    }
  ...
  public static Object \u03B4(Object state, Object \u03C3) {
    ...
    $try:try {
      ...
      if ($opEqualY(q,"Err")) {
        ...
        if ($opMembrY(q,preOps)) {
          ...
          if ($opMembrY($opAdditY(q,\u03C3),preOps)) {
            ...
            $line=124;
            if ($bool(Tp4Lexer202420.problems($cast(java.lang.String.class,q)))) {
              $line=124;
              $result="Err";
              if (true) break $try;
            }
      ...
      $rethrow($throwable,Tp4Lexer202420.class,"\u03B4",$line);
    }
    return $result;
  }
  public static Object g(Object q) {
    ...
    $try:try {
      ...
      $rethrow($throwable,Tp4Lexer202420.class,"g",$line);
    }
    return $result;
  }
  public static Object h(Object q, Object \u03C3) {
    ...
    $try:try {
      ...
      if ($opMembrY(q,preOps)) {
          ...
          if ($opMembrY($opAdditY(q,\u03C3),preOps)) {
            ...
            if (($opMembrY(\u03C3,$opUnionY(StartOps,alphaNum))&&$opMembrY(q,allSymbols))) {
              ...
              if ($opMembrY(\u03C3,$opUnionY($opUnionY($opUnionY(StartOps,alphaNum),skipChars),GCollections.asSet(':','\"')))) {
                ...
                currentString=$cast(String.class,$fix($opAdditY("",s)));
                $line=178;
                $result=Tp4Lexer202420.translationPreOps(q);
                if (true) break $try;
              }
              else {
                $line=180;
        ...
        if ((!$opMembrY(q,GCollections.asSet("Err"))&&$opMembrY(\u03C3,$opUnionY(skipChars,StartOps)))) {
          ...
          if ($opEqualY(q,"INIT")) {
            ...
            $line=189;
            if ($opEqualY(Tp4Lexer202420.translationGet(q),null)) {
              $line=191;
              ((gold.structures.list.GArrayList)images).add(currentString);
              $line=192;
              ...
              if ($opMembrY(f,alphaUpper)) {
                $line=194;
                $result=Tp4Lexer202420.translationGet("IdU");
                if (true) break $try;
              }
              else {
                $line=195;
                if ($opMembrY(f,alphaLower)) {
                  $line=196;
                  $result=Tp4Lexer202420.translationGet("IdL");
                  if (true) break $try;
                }
                else {
                  $line=197;
      ...
      $rethrow($throwable,Tp4Lexer202420.class,"h",$line);
    }
    return $result;
  }
  public static Object initialize() {
    ...
    $try:try {
      ...
      $line=221;
      keyWords=$cast(ISet.class,$fix(GCollections.asSet("forward","fd","right","rt","left","lt","clearscreen","cs","penup","pendown","hideturtle","showturtle","home","setx","setxy","seth","arc","repeat","backward","bk","setwidth","setw","make","\"","l","to",":","end")));
      $line=251;
      allSymbols=$cast(ISet.class,$fix(GCollections.asSet("[","]","\"",":")));
      $line=260;
      ((gold.structures.map.GHashTableMap)translation).put("forward",'f');
      $line=261;
      ((gold.structures.map.GHashTableMap)translation).put("fd",'f');
      $line=263;
      ((gold.structures.map.GHashTableMap)translation).put("right",'r');
      $line=264;
      ((gold.structures.map.GHashTableMap)translation).put("rt",'r');
      $line=266;
      ((gold.structures.map.GHashTableMap)translation).put("left",'l');
      $line=267;
      ((gold.structures.map.GHashTableMap)translation).put("lt",'l');
      $line=270;
      ((gold.structures.map.GHashTableMap)translation).put("pendown",'d');
      $line=271;
      ((gold.structures.map.GHashTableMap)translation).put("penup",'u');
      $line=273;
      ((gold.structures.map.GHashTableMap)translation).put("clearscreen",'c');
      $line=274;
      ((gold.structures.map.GHashTableMap)translation).put("cs",'c');
      $line=275;
      ((gold.structures.map.GHashTableMap)translation).put("hideturtle",'c');
      $line=276;
      ((gold.structures.map.GHashTableMap)translation).put("showturtle",'c');
      $line=279;
      ((gold.structures.map.GHashTableMap)translation).put("home",'c');
      $line=281;
      ((gold.structures.map.GHashTableMap)translation).put("setx",'f');
      $line=282;
      ((gold.structures.map.GHashTableMap)translation).put("seth",'f');
      $line=283;
      ((gold.structures.map.GHashTableMap)translation).put("setheight",'f');
      $line=284;
      ((gold.structures.map.GHashTableMap)translation).put("setw",'f');
      $line=285;
      ((gold.structures.map.GHashTableMap)translation).put("setwidth",'f');
      $line=288;
      ((gold.structures.map.GHashTableMap)translation).put("setxy",'F');
      $line=289;
      ((gold.structures.map.GHashTableMap)translation).put("arc",'F');
      $line=292;
      ((gold.structures.map.GHashTableMap)translation).put("repeat",'R');
      $line=293;
      ((gold.structures.map.GHashTableMap)translation).put("backward",'f');
      $line=294;
      ((gold.structures.map.GHashTableMap)translation).put("bk",'f');
      $line=297;
      ((gold.structures.map.GHashTableMap)translation).put("to",'T');
      $line=298;
      ((gold.structures.map.GHashTableMap)translation).put("end",'E');
      $line=301;
      ((gold.structures.map.GHashTableMap)translation).put("make",'m');
      $line=302;
      ...
      ((gold.structures.map.GHashTableMap)translation).put("]",']');
      $line=308;
      ((gold.structures.map.GHashTableMap)translation).put("IdL",'i');
      $line=309;
      ((gold.structures.map.GHashTableMap)translation).put("IdU",'i');
      $line=311;
      ((gold.structures.map.GHashTableMap)translation).put("Num",'#');
    }
    catch (Throwable $throwable) {
      $rethrow($throwable,Tp4Lexer202420.class,"initialize",$line);
    }
    return $result;
  }
}
